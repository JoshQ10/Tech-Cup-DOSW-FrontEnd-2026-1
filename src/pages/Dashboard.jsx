...
const proximosPartidos = [
  {
    equipoLocal: "Alianza por el cine",
    equipoVisitante: "Penguin Contrucction",
    fecha: "Hoy",
    hora: "4:00 pm",
    cancha: "Julio Garavito",
  }
];

const tablaPosiciones = [
  { pos: 1, nombre: "Alianza por el cine",   pts: 10 },
  { pos: 2, nombre: "Penguin construction",  pts: 9  },
  { pos: 3, nombre: "Fuerza y Traccion",     pts: 5  },
];
...
export default function Dashboard() {
  ...
  return (
      <div className="flex h-screen w-full overflow-hidden relative" style={{ background: '#000F20' }}>
              ...
              <div className="px-6 pb-8 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-xl p-4 min-h-[260px]" style={CARD}>
                  ...
                  {proximosPartidos.map((p, i) => (
                      ...
                      <span className="text-white text-xs font-semibold flex-1 text-left" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        {p.equipoLocal}
                      </span>
                          <span className="text-yellow-400 font-bold text-sm px-2" style={{ fontFamily: "'Anton SC', sans-serif" }}>VS</span>
                          <span className="text-white text-xs font-semibold flex-1 text-right" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        {p.equipoVisitante}
                      </span>
                        </div>
                        {/* Info */}
                        <div className="flex items-center gap-4 text-xs" style={{ color: 'rgba(255,255,255,0.55)', fontFamily: "'Inter', sans-serif" }}>
                ...
                <div className="rounded-xl p-4" style={CARD}>
                  <h2 className="text-white text-sm font-semibold mb-3" style={{ fontFamily: "'Poppins', sans-serif" }}>
                    Noticias & Datos
                  </h2>
                  <div className="rounded-lg p-4 flex items-center gap-4"
                       style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)' }}>
                    {userPhoto ? (
                        <img src={userPhoto} alt="Goleador" className="w-16 h-16 rounded-full object-cover flex-shrink-0"
                             style={{ border: '2px solid #003C81' }} />
                    ) : (
                    ...
                    <span className="text-xs" style={{ color: 'rgba(255,255,255,0.55)', fontFamily: "'Inter', sans-serif" }}>
                      El Máximo Goleador de esta semana es
                    </span>
                      <span className="text-white font-bold text-lg uppercase" style={{ fontFamily: "'Anton SC', sans-serif" }}>
                      {loading ? '...' : userName}
                    </span>
                      <span className="text-yellow-400 font-bold text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>
                      10 Goles
                    </span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    {tablaPosiciones.map((equipo, i) => (
                        <div key={i} className="flex items-center gap-3 rounded-lg px-3 py-2"
                          ...
                          <span className="text-base">{medallas[i]}</span>
                          <span className="text-white text-xs flex-1" style={{ fontFamily: "'Inter', sans-serif" }}>
                        {equipo.nombre}
                      </span>
                          <span className="text-yellow-400 text-xs font-bold" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        {equipo.pts} pts
                      </span>
                        </div>
                    ))}
        ...
        {/* Robot decorativo */}
        <div className="fixed pointer-events-none z-10" style={{ width: '180px', bottom: '-16px', right: '-20px' }}>
          <img src={robotCurioso} alt="Robot Curioso" className="w-full h-auto object-contain" />
        </div>
      </div>
  );
}