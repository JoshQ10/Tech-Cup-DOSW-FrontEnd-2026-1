...
function InvitationDecisionModal({ invitation, onAccept, onReject }) {
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center px-4" style={{ background: 'rgba(0,0,0,0.45)' }}>
      <div className="relative w-full max-w-4xl rounded-2xl bg-[#e8e8e8] py-10 pl-56 pr-10">
        <img
          src={robotModal}
          alt="Robot invitacion"
          className="absolute left-2 bottom-0 h-[320px] w-auto object-contain"
        />
        ...
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <p className="text-[#374151]" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Invitacion de {invitation.teamName}
          </p>

          <div className="flex w-full max-w-[360px] items-center justify-between gap-8">
            <button
              onClick={onAccept}
              className="h-10 flex-1 rounded-lg bg-[#0B4F9B] text-[26px] text-white shadow-md transition hover:brightness-110"
              style={{ fontFamily: "'Anton SC', sans-serif" }}
            >
              Si
            </button>
